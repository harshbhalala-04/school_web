...
class GraphType extends StatefulWidget {
  const GraphType({Key? key}) : super(key: key);

  @override
  State<GraphType> createState() => _GraphTypeState();
}

class _GraphTypeState extends State<GraphType> {
